...
async function getCountries() {
    try {
        ...
        const result = await (0, _axiosDefault.default).get(`https://restcountries.com/v3.1/name/${countryName}`);
...
function getAllCurrenciesString(currencies) {
    const currencyArray = [];
    if (!currencies) return "and this country has no currencies.";
    Object.keys(currencies).forEach((key)=>{
        currencyArray.push(Object.values(currencies[key])[0]);
    });
    let currencyString = `and you can pay with ${currencyArray[0]}'s`;
    if (currencyArray.length > 1) for(let i = 1; i < currencyArray.length; i++)currencyString += ` and ${currencyArray[i]}'s`;
    currencyString += ".";
...
function getAllLanguagesString(languages) {
    const languageArray = [];
    if (!languages) return "no known language.";
    Object.keys(languages).forEach((key)=>{
        languageArray.push(languages[key]);
    });
    let languageString = `${languageArray[0]}`;
    if (languageArray.length > 1) for(let i = 1; i < languageArray.length; i++)languageString += ` and ${languageArray[i]}`;
    languageString += ".";
...
var Buffer = require("d3078d297b1bc10c").Buffer;
"use strict";
/**
...
},{"d3078d297b1bc10c":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("1d3e3dff77dc0e20");
var ieee754 = require("873966d287851ec4");
...
},{"1d3e3dff77dc0e20":"eIiSV","873966d287851ec4":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequire5e27")
